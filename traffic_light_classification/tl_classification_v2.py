...
if __name__=='__main__':
    ...
    model_best_name='model_b_lr-'+str(abs(lr))+'_ep'+str(epochs)+'_ba'+str(batch_size)+'15C'\
                   +'.h5'
    model_best_name = os.path.join(saved_model_dir, model_best_name)             
    model_final_name='model_f_lr-'+str(abs(lr))+'_ep'+str(epochs)+'_ba'+str(batch_size)+'15C'\
                   +'.h5'
