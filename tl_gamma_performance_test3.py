...
if __name__ == '__main__':
        ...
        det_conf = [];
        failed_img_names =[];
        TEST_IMAGE_PATHS= glob(os.path.join('sun_red_new/', '*.png'))
        #!!!!!!!!!!
        use_gamma = True
        #!!!!!!!!!!!
        plot_image = True
        for i, image_path in enumerate(TEST_IMAGE_PATHS):
            ...
            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            img_full_np_copy = np.copy(img_full_np) # make one copy
            img_full_np_copy2 = np.copy(img_full_np) # make another copy
            ...
            img_full_np_copy = img_full_np_copy[20:400, 0:800]
            img_full_np_copy2 = img_full_np_copy2[20:400, 0:800]
            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            start = time.time()
            ...
            if np.array_equal(b1, np.zeros(4)):
               ...
               plt.show()
               #!!!!!!!!!!!!!!!!Cropping traffic light from original image!!!!!!!!!!!!
               cv2.rectangle(img_full_np_copy2,(b1[1],b1[0]),(b1[3],b1[2]),(0,255,0),2)
               plt.figure(figsize=(9,6))
               plt.imshow(img_full_np_copy2)
               plt.title("Cropping only")
               plt.show()
               ...
               if (tl_cls.signal_status == "Red"):# or (tl_cls.signal_status == "Red"):
                   no_correct_cls +=1
